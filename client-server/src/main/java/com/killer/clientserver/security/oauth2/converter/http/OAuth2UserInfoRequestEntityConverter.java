...
public class OAuth2UserInfoRequestEntityConverter implements Converter<OAuth2UserRequest, RequestEntity<?>> {
    ...
    public RequestEntity<?> convert(OAuth2UserRequest userRequest) {
        ...
        URI uri = UriComponentsBuilder.fromUriString(clientRegistration.getProviderDetails().getUserInfoEndpoint().getUri())
                ...
                .queryParam("oauth_consumer_key", userRequest.getClientRegistration().getClientId())
                .queryParam("openid", ((HashMap<String, String>)userRequest.getAdditionalParameters().get("params")).get("openId"))
                .build()
                .toUri();
